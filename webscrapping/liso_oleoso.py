...
url = 'https://www.belezanaweb.com.br/cabelos/kits-de-tratamento/com-caspa-ou-problemas-do-couro-cabeludo/'
...
if site_content:
    ...
    for i in range(1, ultima_pagina + 1):
        url_pag = f'https://www.belezanaweb.com.br/cabelos/kits-de-tratamento/com-caspa-ou-problemas-do-couro-cabeludo/?page_number={i}'
    ...
    # Inserir dados na tabela 'LISO_OLEOSO'
    try:
        df.to_sql(name='LISO_OLEOSO', con=engine, if_exists='append', index=False)
        print("Dados inseridos na tabela 'LISO_OLEOSO' do banco de dados MySQL.")
