...
url = 'https://www.belezanaweb.com.br/cabelos/kits-de-tratamento/ressecados-ou-secos/'
...
if site_content:
    ...
    for i in range(1, ultima_pagina + 1):
        url_pag = f'https://www.belezanaweb.com.br/cabelos/kits-de-tratamento/ressecados-ou-secos/?page_number={i}'
    ...
    # Inserir dados na tabela 'ONDULADO_SECO'
    try:
        df.to_sql(name='ONDULADO_SECO', con=engine, if_exists='append', index=False)
        print("Dados inseridos na tabela 'ONDULADO_SECO' do banco de dados MySQL.")
