...
url = 'https://www.belezanaweb.com.br/cabelos/kits-de-tratamento/cacheados-ou-ondulados/'
...
if site_content:
    ...
    for i in range(1, ultima_pagina + 1):
        url_pag = f'https://www.belezanaweb.com.br/cabelos/kits-de-tratamento/cacheados-ou-ondulados/?page_number={i}'
    ...
    # Inserir dados na tabela 'CACHEADO_NORMAL'
    try:
        df.to_sql(name='CACHEADO_NORMAL', con=engine, if_exists='append', index=False)
        print("Dados inseridos na tabela 'CACHEADO_NORMAL' do banco de dados MySQL.")
