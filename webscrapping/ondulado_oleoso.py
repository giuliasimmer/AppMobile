...
url = 'https://www.belezanaweb.com.br/cabelos/kits-de-tratamento/oleosos-ou-mistos/'
...
if site_content:
    ...
    for i in range(1, ultima_pagina + 1):
        url_pag = f'https://www.belezanaweb.com.br/cabelos/kits-de-tratamento/oleosos-ou-mistos/?page_number={i}'
    ...
    # Inserir dados na tabela 'ONDULADO_OLEOSO'
    try:
        df.to_sql(name='ONDULADO_OLEOSO', con=engine, if_exists='append', index=False)
        print("Dados inseridos na tabela 'ONDULADO_OLEOSO' do banco de dados MySQL.")
