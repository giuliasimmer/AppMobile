...
url = 'https://www.belezanaweb.com.br/cabelos/kits-de-tratamento/com-queda-ou-ralos/'
...
if site_content:
    ...
    for i in range(1, ultima_pagina + 1):
        url_pag = f'https://www.belezanaweb.com.br/cabelos/kits-de-tratamento/com-queda-ou-ralos/?page_number={i}'
    ...
    # Inserir dados na tabela 'CACHEADO_OLEOSO'
    try:
        df.to_sql(name='CACHEADO_OLEOSO', con=engine, if_exists='append', index=False)
        print("Dados inseridos na tabela 'CACHEADO_OLEOSO' do banco de dados MySQL.")
