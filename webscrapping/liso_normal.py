...
url = 'https://www.belezanaweb.com.br/cabelos/kits-de-tratamento/lisos/'
...
if site_content:
    ...
    # Inserir dados na tabela 'LISO_NORMAL'
    try:
        df.to_sql(name='LISO_NORMAL', con=engine, if_exists='append', index=False)
        print("Dados inseridos na tabela 'LISO_NORMAL' do banco de dados MySQL.")
