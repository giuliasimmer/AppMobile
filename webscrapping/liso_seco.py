...
url = 'https://www.belezanaweb.com.br/cabelos/kits-de-tratamento/finos/'
...
if site_content:
    ...
    # Inserir dados na tabela 'LISO_SECO'
    try:
        df.to_sql(name='LISO_SECO', con=engine, if_exists='append', index=False)
        print("Dados inseridos na tabela 'LISO_SECO' do banco de dados MySQL.")
