...
url = 'https://www.belezanaweb.com.br/cabelos/kits-de-tratamento/'
...
if site_content:
    ...
    # Inserir dados na tabela 'Kit'
    try:
        df.to_sql(name='Kit', con=engine, if_exists='append', index=False)
        print("Dados inseridos na tabela 'Kit' do banco de dados MySQL.")
